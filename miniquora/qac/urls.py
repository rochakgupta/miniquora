...
urlpatterns = [
    ...
    url(r'^(?P<id>\d+)/delete/$', delete_question, name="delete-question"),
    ...
    url(r'^(?P<id>\d+)/answer/(?P<a_id>\d+)/comment/(?P<c_id>\d+)/edit/$', edit_answer_comment,
        name="edit-answer-comment"),
    url(r'^(?P<id>\d+)/answer/(?P<a_id>\d+)/comment/(?P<c_id>\d+)/delete/$', delete_answer_comment,
